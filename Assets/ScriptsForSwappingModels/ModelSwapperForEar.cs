...
public class ModelSwapperForEar : MonoBehaviour, ITrackableEventHandler 
{
	...
	private void SwapToWithParts() {
		...
		if (count == 0) {
			...
			WithPartPrefab.transform.localPosition=new Vector3(0.073f,-0.021f,-0.224f);
			WithPartPrefab.transform.localRotation=Quaternion.Euler(357.9214f,6.60941f,268.6656f);
			WithPartPrefab.transform.localScale=new Vector3(7.276516e-05f,7.276516e-05f,7.276516e-05f);
