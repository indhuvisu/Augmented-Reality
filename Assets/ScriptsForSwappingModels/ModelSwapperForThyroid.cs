...
public class ModelSwapperForThyroid : MonoBehaviour, ITrackableEventHandler 
{
	...
	private void SwapToWithParts() {
		...
		if (count == 0) {
			...
			WithPartPrefab.transform.localPosition=new Vector3(0.103f,0.439f,-0.369f);
			WithPartPrefab.transform.localRotation=Quaternion.Euler(70.08497f,33.85016f,29.52778f);
			WithPartPrefab.transform.localScale=new Vector3(0.13f,0.13f,0.13f);
